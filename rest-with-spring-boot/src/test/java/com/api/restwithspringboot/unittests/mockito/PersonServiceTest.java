package com.api.restwithspringboot.unittests.mockito;
...
import com.api.restwithspringboot.unittests.mapper.mocks.MockPerson;
...
class PersonServiceTest {
    ...
    @Test
    void testFindAll() {
        List<Person> personsMockList = input.mockEntityList();
